// Configurazione strategie separata in components/StrategyConfig.js.
const COMPAT = window.PRISMA_STRATEGY_CONFIG.COMPAT;

const TYPE_LABELS = window.PRISMA_STRATEGY_CONFIG.TYPE_LABELS;

const STRATEGY_CHANNEL_META = window.PRISMA_STRATEGY_CONFIG.STRATEGY_CHANNEL_META;

// I contatti operatori sono separati in components/OperatorsPanel.js.
const OPERATOR_CONTACTS = window.OPERATOR_CONTACTS || {};

const STRATEGY_PROMO_LIBRARY = window.PRISMA_STRATEGY_CONFIG.STRATEGY_PROMO_LIBRARY;
